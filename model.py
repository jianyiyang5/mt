...
class EncoderRNN(nn.Module):
    def __init__(self, input_size, hidden_size, device, layers=3, dropout_p=0.1):
...
class AttnDecoderRNN(nn.Module):
    def __init__(self, hidden_size, output_size, device, layers=3, dropout_p=0.1, max_length=MAX_LENGTH):
