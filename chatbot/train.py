...
import os
import random
from preprocess import loadPrepareData, trimRareWords, MIN_COUNT
from prepare_data import batch2TrainData
from model import EncoderRNN, LuongAttnDecoderRNN
from voc import SOS_token
...
def trainIters(model_name, voc, pairs, encoder, decoder, encoder_optimizer, decoder_optimizer, embedding, encoder_n_layers,
               ...
               checkpoint, hidden_size, teacher_forcing_ratio, device):
    ...
    for iteration in range(start_iteration, n_iteration + 1):
        ...
        loss = train(input_variable, lengths, target_variable, mask, max_target_len, encoder, decoder,
                     encoder_optimizer, decoder_optimizer, batch_size, clip, device, teacher_forcing_ratio)
        print_loss += loss
